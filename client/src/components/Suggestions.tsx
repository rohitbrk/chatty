      ...
      <>
        {showCommunities ? (
          <ul className="flex flex-col">
            <hr className="h-px mx-8 mt-4 mb-3 bg-gray-300 border-0" />
            {communities.map((item) => (
              <li
                key={item}
                className="mx-20 flex justify-evenly mb-1 block text-lg font-medium leading-tight inline-block whitespace-nowrap rounded-1 bg-primary-100 align-baseline font-bold leading-none text-gray-700"
              >
                <>{item}</>
