...
const Info = ({ name, URL, room, setMsgs, deleteRoom }: InfoProps) => {
  ...
  return (
    <div className="flex flex-col w-full max-w-md bg-white shadow-md rounded px-8 py-4 hover:shadow-lg hover:shadow-black/30">
      <div className="mb-4 flex justify-evenly">
        ...
        <div className="basis-1/2 gap-2 flex justify-center text-gray-800 bg-gray-300 font-bold py-2 px-3 rounded">
          {room}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
